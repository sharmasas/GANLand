...
let PATH = "/Users/sanjanasharma/Desktop/collaborative-creation-app/level2/";
// hide results button
...
// images for level2: 1 is PHOTO, 0 is GAN
image_array = [
	{image: "lfw_002.jpg", value: 1},
	{image: "lfw_003.jpg", value: 1},
	{image: "e05_000.png", value: 0},
	{image: "e05_001.png", value: 0},
	{image: "e05_002.png", value: 0}
];
...
/** LOGIC TO DECIDE WHAT LEVEL USER SHOULD BE TAKEN NEXT (LEVEL2) **/
...
function chartData() {
  ...
  sessionStorage.setItem(id, JSON.stringify(session2));
}
