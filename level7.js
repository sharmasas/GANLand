...
let PATH = "/Users/sanjanasharma/Desktop/collaborative-creation-app/level7/";
// hide results button
...
// images for level7: 1 is PHOTO, 0 is GAN
image_array = [
	{image: "fl_010.png", value: 1},
	{image: "fl_011.png", value: 1},
	{image: "fl_012.png", value: 1},
	//{image: "fl_013.png", value: 1},
	//{image: "fl_014.png", value: 1},
	{image: "tpdne_004.png", value: 0},
	{image: "tpdne_005.png", value: 0},
	{image: "tpdne_006.png", value: 0},
	{image: "tpdne_007.png", value: 0},
	//{image: "tpdne_008.png", value: 0}
];
...
$('#result-btn').click(function(e) {
  ...
  if (performance_data[4] == 100) {
  	document.getElementById("level-set").innerHTML = "Summary >";
  	document.getElementById("feedback").innerHTML = 
  	"<b>Congratulations!</b> You’ve successfully distinguished between the photos and generated images at each stage of the training process. The generator can now produce convincing images, thanks to your stellar performance as the discriminator. The next page will show you a summary of your performance overall.";
  }
  else {
  	document.getElementById("level-set").innerHTML = "Next Round >";
  	document.getElementById("feedback").innerHTML = 
...
/// ** LOGIC TO DECIDE WHAT LEVEL USER SHOULD BE TAKEN NEXT (LEVEL1) **/
...
function chartData() {
  ...
  session7 = performance_data;
  // sanity check: print session data
  console.log("session7: " + session7);
  ...
  sessionStorage.setItem(id, JSON.stringify(session7));
}
